                                                    ...
                                                    <div className="services__details-top-content">
                                                        ...
                                                        <div className="about__list-box about__list-box-three">
                                                            <ul className="list-wrap">
                                                                <li><i className="fa icon-arrow" />Business Growth</li>
                                                                <li><i className="fa icon-arrow" />100% Secure</li>
                                                                <li><i className="fa icon-arrow" />Research</li>
                                                                <li><i className="fa icon-arrow" />100% Secure</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <aside className="services__sidebar">
                                            <div className="sidebar__widget sidebar__widget-three">
                                                <div className="sidebar__cat-list-two sidebar__cat-list-three">
                                                    <ul className="list-wrap">
                                                        <li><Link href="/services-details">Investment Planning <i className="fa icon-arrow" /></Link></li>
                                                        <li><Link href="/services-details">Strategic marketing <i className="fa icon-arrow" /></Link></li>
                                                        <li><Link href="/services-details">Insights  analytics <i className="fa icon-arrow" /></Link></li>
                                                        <li><Link href="/services-details">Business consulting <i className="fa icon-arrow" /></Link></li>
                                                        <li><Link href="/services-details">Financial Advisory <i className="fa icon-arrow" /></Link></li>
                                                        <li><Link href="/services-details">Market Research <i className="fa icon-arrow" /></Link></li>
                                                    </ul>
                                                </div>
                                            </div>
